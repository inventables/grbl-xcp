...
/* The defaults.h file serves as a central default settings selector for different machine
...
#ifdef DEFAULTS_X_CARVE_PRO
  // Description: X-Carve Pro 3D Carver CNC mill with four 200 step/rev motors driven by
  // TI DRV8711 at 48V.
  #define MICROSTEPS_XY 4U
  #define STEP_REVS_XY 200
  #define MM_PER_REV_XY (10.0*34/18) // 10 mm lead ball screw, 34 tooth pulley on motor, 18 tooth pulley on ball screw
  #define MICROSTEPS_Z 8U
  #define STEP_REVS_Z 200
  #define MM_PER_REV_Z (10.0*18/18) // 10 mm lead ball screw, 18 tooth pulley on motor, 18 tooth pulley on ball screw
  #define DEFAULT_X_STEPS_PER_MM (MICROSTEPS_XY*STEP_REVS_XY/MM_PER_REV_XY)
  #define DEFAULT_Y_STEPS_PER_MM (MICROSTEPS_XY*STEP_REVS_XY/MM_PER_REV_XY)
  #define DEFAULT_Z_STEPS_PER_MM (MICROSTEPS_Z*STEP_REVS_Z/MM_PER_REV_Z)
  ...
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
  #define DEFAULT_DIRECTION_INVERT_MASK ((1<<Y_AXIS)|(1<<N_AXIS)|(1<<Z_AXIS))
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 255 // msec (0-254, 255 keeps steppers enabled)
  #define DEFAULT_STATUS_REPORT_MASK 1 // MPos enabled
  #define DEFAULT_JUNCTION_DEVIATION 0.02 // mm
  #define DEFAULT_ARC_TOLERANCE 0.002 // mm
